...
<body>
    ...
    <div class="main-content">
        <div class="main-header">
            ...
            <p>Add new student marks information</p>
        </div>

        <div class="content">
            <div class="form-section">
                <div class="form-header">
                    <h3 class="form-title">Add Student Marks</h3>
                    <p class="form-subtitle">Enter the student's marks below</p>
                </div>

                <form method="POST" action="{{ route('exam_mark.store') }}" class="edit-form">
                    @csrf
                    ...
                    <div class="form-row">
                        <div class="form-group">
                            ...
                            <input type="number" name="mark" id="mark" min="0" max="100" required>
                            @error('mark')
                                <span class="error-message">{{ $message }}</span>
                            @enderror
                        </div>
