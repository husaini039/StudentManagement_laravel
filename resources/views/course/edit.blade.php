        ...
        <div class="content">
            <div class="form-section">
                <div class="form-header">
                    <h3 class="form-title">Edit Course Information</h3>
                    <p class="form-subtitle">Update the course's details below</p>
                </div>

                <form method="POST" action="{{ route('courses.update', $course->id) }}" class="edit-form">
                    @csrf
                    @method('PUT')
