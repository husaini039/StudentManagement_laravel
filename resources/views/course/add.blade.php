        ...
        <div class="content">
            <div class="form-section">
                <div class="form-header">
                    <h3 class="form-title">Add Course Information</h3>
                    <p class="form-subtitle">Add course details below</p>
                </div>

                <form method="POST" action="{{ route('courses.store') }}" class="edit-form">
                    @csrf
                    <div class="form-row">
                    ...
                    <div class="form-row">
                        <div class="form-group">
                            ...
                            <input type="number"  name="credit_hours" value="{{ old('credit_hours') }}" required>
                            @error('credit_hours')
                                <span class="error-message">{{ $message }}</span>
                            @enderror
                        </div>
